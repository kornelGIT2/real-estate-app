...
export const estateDummyData = [
  ...
  },
  {
    ...
    type: "Studio",
    price: 3000,
    info: "Luxurious living with stunning views of the Baltic Sea.",
    position: [54.4416, 18.5601],
    dimensions: 400,
  },
  {
    id: 16,
    title: "Historic Townhouse in Warsaw Old Town",
  ...
  {
    id: 6,
    title: "Rustic Cottage in Zakopane Mountains 2",
  ...
  {
    id: 15,
    title: "Rustic Cottage in Zakopane Mountains",
    ...
    type: "Cottage",
    price: 3500,
    info: { type: 1, desc: "Added 3 hour ago" },
  ...
  },
  {
    ...
    city: "Krakow",
    image: "/assets/apartments/ap9.jpg",
    bedroom: 2,
    bathroom: 1,
    type: "Apartment",
    price: 2500,
